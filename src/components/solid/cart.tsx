...
const EmptyState = () => (
  <>
    ...
    <p class={styles.empty}>Your cart is empty! Add a sandwitch kit or two and give flavour a chance.</p>
  </>
);

const CheckoutNotice = () => <p class={styles.notice}>Checkout is not implemented yet.</p>;
            ...
            {(entry) => (
              <li class={styles.item}>
                ...
                <span class={styles.remove}>
                  <button title='remove item' onClick={() => removeFromCart(entry.item.id)}>
                    &times;
                  </button>
                </span>
